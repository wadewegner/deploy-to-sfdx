...
5. Create a `tmp` directory to store temp deployment files.
...
10. Run `npm install` to install node dependencies.

11. [Install JQ](https://github.com/stedolan/jq/wiki/Installation) for JSON parsing.
