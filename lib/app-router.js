    ...
    switch (command) {
      ...
      case 'create':
        ...
        commands.run(command, script, () => {
          ...
          script = `${startingDirectory}cd ${directory};export FORCE_SHOW_SPINNER=;sfdx force:org:create -v '${access_token}' -s -f ${param} | jq -r .result.username`;
          ...
          commands.run(command, script, (commandResult, commandErr) => {
            ...
            if (commandErr) {
              ...
              res.json({
                message: `Org created with User ${commandResult}`
              });
            }
