  ...
  router.post('/deploying', (req, res) => {
    ...
    switch (command) {
      ...
      case 'apex':
        ...
        async.eachSeries(param, function iteratee(apex, callback) {
      ...
      case 'packages':
        let pkgMessage = 'Packages installed:';
        async.eachSeries(param, function iteratee(pkg, callback) {
          console.log(`installing ${pkg}`);
          script = `${startingDirectory}cd ${directory};export FORCE_SHOW_SPINNER=;sfdx force:package:install -i ${pkg} -w 10`;
      ...
      case 'data':
        ...
        async.eachSeries(param, function iteratee(plan, callback) {
          console.log(`installing ${plan}`);
